...
<div class="row my-5">
    <div class="col">
        ...
        //   RETRIVE NEWS
            $post_sql = "SELECT *, posts.id AS postid, c.id  FROM posts JOIN categories AS c ON posts.category_id = c.id";
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="../assets/images/<?php echo $post_row['thumnail'];?>" width="70px" alt=""></td>
                                <td>
