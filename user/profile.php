    ...
    <div class="col">
        <div class="card p-3 user-info">
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item"><span><i class="fa-solid fa-lock me-2"></i></i>Password:</span> <a href="change-password.php" class="btn btn-sm bg-warning">Change password</a> </li>
            </ul>
        </div>
    </div>
</div>
